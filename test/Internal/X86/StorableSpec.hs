...
getX86OpMemStruct = do
    ...
    poke (plusPtr ptr 8) (0x13052746 :: Word32)
...
x86OpMemStruct =
    X86OpMemStruct 0x01234567 0x10325476 0x13052746 0x31507264 0x3df1507264 
...
csX86Op :: CsX86Op
csX86Op = CsX86Op (Imm 0x0123456789abcdef) 2 X86AvxBcast4 True
...
getCsX86 = do
    ...
    poke (plusPtr ptr 12) (0x01234567 :: Int32)
    poke (plusPtr ptr 16) (fromIntegral $ fromEnum X86RegAl :: Int32)
    poke (plusPtr ptr 20) (0x2 :: Int8)
    poke (plusPtr ptr 24) (fromIntegral $ fromEnum X86RegEdx :: Int32)
    poke (plusPtr ptr 28) (fromIntegral $ fromEnum X86SseCcEq :: Int32)
    poke (plusPtr ptr 32) (fromIntegral $ fromEnum X86AvxCcEq :: Int32)
    poke (plusPtr ptr 36) (0x1 :: Word8)
    poke (plusPtr ptr 40) (fromIntegral $ fromEnum X86AvxRmRu :: Int32)
    poke (plusPtr ptr 44) (0x1 :: Word8)
    poke (plusPtr ptr 48) csX86Op
    peek (castPtr ptr) <* free ptr

csX86 :: CsX86
csX86 = CsX86 (Nothing, Just 0x1, Just 0x2, Just 0x3)
    [0x4, 0x5, 0x6, 0x7] 0x0 0x20 0x21 Nothing (Just 0x01234567) X86RegAl
    0x2 X86RegEdx X86SseCcEq X86AvxCcEq True X86AvxRmRu [csX86Op]
